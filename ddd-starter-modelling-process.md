...
![DDD Starter Modelling Process](assets/images/process/ddd-starter-modeling-circular.svg) 
...
![The Business Model Canvas](assets/images/process/business-model-canvas.png)
...
![EventStorming](assets/images/process/event_storming.jpeg)
...
![Sub-domains on an EventStorm](assets/images/process/event_storm_sub_domains.png)*Credit: Alberto Brandolini*
...
![Core Domain Charts](assets/images/process/core-domain-chart.jpg)
...
![Domain Message Flow Modelling](assets/images/process/domain-message-flow.jpg)
...
![Context Map](assets/images/process/context-map-cheat-sheet.png)*Credit: Michael Plöd*
...
![Bounded Context Canvas](assets/images/process/bounded-context-canvas-v5.jpg)
...
![Aggregate Design Canvas](assets/images/process/aggregate-design-canvas-v1.jpg)
...
![WhirlpoolVSStarter](assets/images/process/ENWhirlpoolVSStarter.jpg)  
